...
class DerivedXLineBuilder {
 public:
  ...
  // events_metadata_per_level. However, if it is shorter, nullopt will be
  // treated padding at the end of the scope_range_ids; and if it is longer, the
  // extra scope_range_ids will be ignored.
